...
export default function CollegesPage() {
  ...
  const validateForm = () => {
    ...
    if (!formData.code.trim()) {
      ...
      errors.code = 'College code must be between 2 and 10 characters'
    }
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      if (editingCollege) {
        ...
        await apiClient.put(`/courses/colleges/${editingCollege.id}/`, formData)
        setSuccess('College updated successfully')
      } else {
        // Create new college
        await apiClient.post('/courses/colleges/', formData)
  ...
  const handleDelete = async (collegeId: number) => {
    ...
    try {
      await apiClient.delete(`/courses/colleges/${collegeId}/`)
      ...
      <AppLayout>
        <div className="max-w-4xl mx-auto p-6">
          <div className="bg-red-50 border border-red-200 rounded-md p-4">
            ...
            <p className="text-red-700 mt-2">Only administrators can manage colleges.</p>
          </div>
        </div>
      </AppLayout>
    )
    ...
    <AppLayout>
      <div className="max-w-6xl mx-auto p-6">
        ...
        <div className="mb-8">
          ...
          <p className="text-gray-600 mt-2">Manage colleges and faculties in the system</p>
        </div>
        ...
        <div className="bg-white rounded-lg shadow-sm border border-gray-200">
          <div className="px-6 py-4 border-b border-gray-200">
            <h2 className="text-lg font-semibold text-gray-900">Colleges List</h2>
          </div>
                  ...
                  {colleges.map((college) => (
                    <tr key={college.id} className="hover:bg-gray-50">
                      <td className="px-6 py-4 whitespace-nowrap">
                        <span className="text-sm font-medium text-gray-900">{college.code}</span>
                      </td>
                      <td className="px-6 py-4 whitespace-nowrap">
                        <span className="text-sm text-gray-900">{college.name}</span>
                      </td>
                      <td className="px-6 py-4">
                        <span className="text-sm text-gray-600">{college.description || '-'}</span>
                      </td>
                      <td className="px-6 py-4 whitespace-nowrap">
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                  ...
                  <div>
                    ...
                    <input
                      ...
                      placeholder="Enter college code (e.g., SCI)"
                    />
                    {formErrors.code && (
