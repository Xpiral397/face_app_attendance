...
def create_dummy_users():
    ...
    # Create students
    students = [
        {"email": "alice.student@university.edu", "username": "alice_student", "full_name": "Alice Johnson", "role": "student", "student_id": "STU100", "level": "300"},
        {"email": "bob.student@university.edu", "username": "bob_student", "full_name": "Bob Williams", "role": "student", "student_id": "STU101", "level": "300"},
        {"email": "charlie.student@university.edu", "username": "charlie_student", "full_name": "Charlie Davis", "role": "student", "student_id": "STU102", "level": "300"},
        {"email": "diana.student@university.edu", "username": "diana_student", "full_name": "Diana Miller", "role": "student", "student_id": "STU103", "level": "300"},
        {"email": "eve.student@university.edu", "username": "eve_student", "full_name": "Eve Garcia", "role": "student", "student_id": "STU104", "level": "300"},
        {"email": "frank.student@university.edu", "username": "frank_student", "full_name": "Frank Rodriguez", "role": "student", "student_id": "STU105", "level": "300"},
        {"email": "grace.student@university.edu", "username": "grace_student", "full_name": "Grace Martinez", "role": "student", "student_id": "STU106", "level": "300"},
        {"email": "henry.student@university.edu", "username": "henry_student", "full_name": "Henry Anderson", "role": "student", "student_id": "STU107", "level": "300"},
    ]
...
def create_dummy_enrollments(assignments, students):
    ...
    for student in students:
        ...
        student_assignments = assignments[:5] if student.student_id in ["STU100", "STU101"] else assignments[:4]
